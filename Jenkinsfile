    ...
    stages {
      stage('Execute ZAP Command on Windows') {
                  ...
                  steps {
                    script {
                      try {
                        bat label: '', script: 'java -Xmx512m -jar "C:/Program Files/OWASP/Zed Attack Proxy/zap-2.13.0.jar" -cmd -port 8084 -autorun "D:/Jenkins/workspace/Suvidha-ZAPscan.yaml"'
                    } catch (Exception e) {
